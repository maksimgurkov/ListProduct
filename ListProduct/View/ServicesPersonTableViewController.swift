//
//  ServicesPersonTableViewController.swift
//  ListProduct
//
...
class ServicesPersonTableViewController: UITableViewController {
    
    var person: Person!
    
    @IBOutlet weak var servicesInfoLabel: UILabel!
    ...
    private func servicesIsEmty() {
        if person.basketService.isEmpty {
            servicesInfoLabel.text = "Услуги не выбраны"
        } else {
            servicesInfoLabel.text = ""
        }
    }
